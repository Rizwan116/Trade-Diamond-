...
-->
          ...
          <li class="nav-item">
            <a class="nav-link" href="diamond.php">
              <i class="mdi mdi-pencil-circle-outline menu-icon"></i>
...
-->
                ...
                <li class="nav-item nav-profile dropdown">
                  ...
                  <div class="dropdown-divider"></div>
                       <a class="dropdown-item" href="../maindashbord/pages/forms/kyc.php">
          ...
          <div class="content-wrapper pb-0">
              ...
              <div class="d-lg-flex align-items-center">
								<div style="padding: 35px">
									<h3 id="_intro" class="text-info font-weight-bold mt-2 text-danger

">Hi, welcome back!</h3>
                                    <h2 class="text-dark font-weight-bold">Search, buy and trade natural diamonds</h2>
									<h5 class="font-weight-normal mb-2">Get Diamonds is the industrys polished diamonds search platform</h5>
...
-->
               ...
               <div class="col-sm-12 flex-column d-flex stretch-card mt-5">
							<div class="row">
...
-->
                                    ...
                                    <div class="card sale-diffrence-border">
										<div class="card-body">
											<h2 class="text-dark mb-2 font-weight-bold">$326</h2>
											<h4 class="card-title mb-2">Diamond Online</h4>
											<small class="text-muted">5/29/2020 6:34:00 PM</small>
										</div>
									</div>
								...
								<div class="col-lg-4 d-flex grid-margin stretch-card">
									<div class="card sale-diffrence-border">
										<div class="card-body">
											<h2 class="text-dark mb-2 font-weight-bold">$228.09</h2>
											<h4 class="card-title mb-2">Total Carats Online</h4>
								...
								<div class="col-lg-4 d-flex grid-margin stretch-card">
									<div class="card sale-visit-statistics-border">
										<div class="card-body">
											<h2 class="text-dark mb-2 font-weight-bold">$1,331,271.00</h2>
											<h4 class="card-title mb-2">Total Value Online</h4>
											<small class="text-muted">APRIL 2019</small>
										</div>
									</div>
								</div>
...
-->
            ...
            <div class="row">
               ...
               <div style="padding: 35px; margin-left: 10px">
                                    <h2 class="text-dark font-weight-bold">Visitors</h2>
									<h5 class="font-weight-normal mb-2">You can manage users from the "Users" section on the left side.
...
-->
            ...
            <div style="padding: 35px; margin-left: 10px">
                                    ...
                                    <h2 class="text-dark font-weight-bold">Diamonds</h2>
									<h5 class="font-weight-normal mb-2">You can manage your diamonds from the "Stock" section on the left side.
</h5>
                  ...
                  <div class="card-body">
                    ...
                    <div class="flot-chart-wrapper">
                      <div id="flotChart" class="flot-chart" style="padding: 0px;">
                        <canvas class="flot-base" width="710" height="216" style="width: 710.75px; height: 216px;"></canvas><div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);"><div class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px;"><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 4px; text-align: center;">4</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 81px; text-align: center;">8</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 155px; text-align: center;">12</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 232px; text-align: center;">16</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 309px; text-align: center;">20</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 387px; text-align: center;">24</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 464px; text-align: center;">28</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 541px; text-align: center;">32</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 618px; text-align: center;">36</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 71px; top: 198px; left: 695px; text-align: center;">40</div></div></div>
                      <canvas class="flot-overlay" width="710" height="216" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 710.75px; height: 216px;"></canvas></div>
                    </div>
                  </div>
                </div>
