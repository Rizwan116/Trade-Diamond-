...
ref.child("member").child(userId).on("value", function(snapshot) {
    ...
    //inputs information
	$('#emails').val(snapshot.val().email);
	$('#firstName').val(snapshot.val().name);
	$('#phonenumber').val(snapshot.val().phoneNumber);
	$('#lastName').val(snapshot.val().lastName);
	$('#state').val(snapshot.val().state);
	$('#country').val(snapshot.val().country);
	$('#fullAddress').val(snapshot.val().fullAddress);
}, function (error) {
          ...
          <div class="content-wrapper">
              <div class="d-lg-flex align-items-center">
								<div style="">
                                    ...
                                    <h2 id="_intro" class="text-dark font-weight-bold">Hello name </h2>
...
-->
            ...
            <div class="page-header">
              <h3 class="page-title mt-5">Personal Details</h3>
                  ...
                  <div class="card-body">
                      <div class="row"> 
                          <div class="col-lg-12" style="text-align:center">
                            <img  src="../../../assets/images/faces/face10.jpg" style="height:150px;border-radius: 75px;">
...
<!--
                          <div class="col-lg-8">
                             <h2 id="_profileName3" class="card-title  mt-4" style="font-size: 26px;margin: 0px 0px 0px 10px;">username </h2>
...
<!--                    <p class="card-description">Basic form layout</p>-->
                      <div class="mt-5"></div>
                       ...
                       <div class="row">
                        ...
                        <input type="text" class="form-control" id="emails" placeholder="Email Address" />
                      </div>
                            </div>
                        </div>
                         <div class="row">
